public class App
{
    ...
    public static void main(String[] args )
    {
        ...
        System.out.println("----------Skenario 1: Registrasi Kasir-------
                        ---");
                Kasir kasir1 = new Kasir("Albertus
                        Adrian","albertusadrian","albertusadrian");
                        Kasir kasir2 = new Kasir("Antonius
                        Felix","antoniusfelix","antoniusfelix");
                        kassa.register(kasir1);
        kassa.register(kasir2);
        System.out.println("----------Skenario 2: Login Gagal----------
                ");
                kassa.login("albertus","albertus");
        System.out.println("----------Skenario 3: Login Berhasil
        Object Username;
        (Username: albertusadrian)----------");
        ...
        kassa.printNota();
        System.out.println("----------Skenario 6: Login Berhasil
        (Username: antoniusfelix)----------");
        ...
        kassa.tambahPesanan(produk4,1);
        kassa.printNota();
        System.out.println("----------Skenario 8: Informasi Pejualan
                Kasir----------");
